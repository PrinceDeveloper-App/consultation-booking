...
/**
 * Admin management of applicant scheduling slots.
 */
class Schedule extends Admin_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('admin/Applicant/Schedullingmodel');
    }

    public function create()
    {
        $next_working_day = $this->get_next_working_day();
        $this->load->view('admin/Applicant/schedullingPage', [
            'pageid'     => 'applicant',
            'breadcrumb' => 'Applicant Scheduling',
    ...
    {
        echo json_encode($this->db->get('slots')->result_array());
    }
